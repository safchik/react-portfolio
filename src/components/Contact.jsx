...
const Contact = () => {
    return (
        <div name='contact' className='w-full sm:h-screen bg-gradient-to-b from-black to-gray-800 p-4 text-white'>
            <div className='flex flex-col p-8 justify-center max-w-screen-lg mx-auto h-full'>
                ...
                <div className='flex justify-center items-center'>
                    <form action='https://getform.io/f/5c65d5be-d4de-449b-b458-053a1c974955' method='POST' className='flex flex-col w-full md:w-1/2'>
